...
# out log file
#PBS -o demux-pileup-p32.out
# err log file
#PBS -e demux-pileup-p32.err
...
ncores=32
bam=~/data/cellsnp-bm/bm1_demux/demux.B.merged.bam
barcode=~/data/cellsnp-bm/bm1_demux/demux.B.barcodes.tsv
fa=~/data/cellranger/refdata-cellranger-hg19-3.0.0/fasta/genome.fa
out_dir=~/projects/csp-bm/result/demux_020221/pileup_p$ncores
